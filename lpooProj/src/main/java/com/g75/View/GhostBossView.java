...
public class GhostBossView implements BossView{
    List<Sprite> sprite = new ArrayList<>();

    public GhostBossView()
    {
        this.sprite.add(new Sprite("boss/bossRight"));
        this.sprite.add(new Sprite("boss/bossLeft"));
        this.sprite.add(new Sprite("boss/bossUpRight"));
        this.sprite.add(new Sprite("boss/bossUpLeft"));
    }
